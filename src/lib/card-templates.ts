...
export const CARD_TEMPLATES: Record<string, CardTemplate> = {
    ...
    root: {
      ...
      children: [
        ...
        },
        {
          id: "heading-tab",
          kind: "section",
          framedHeadingEdge: "top",
          framedHeadingAlign: "center",
          framedHeadingTabWidthPct: 50,
          layout: {
            flex: 0,
            flexDirection: "column",
            alignItems: "stretch",
          ...
          style: {
            backgroundStyle: "gradient",
            backgroundColors: ["#2b6ca1", "#193661"],
            gradientAngle: 315,
            borderColor: "#2a5183",
            borderWidth: 0,
            borderStyle: "none",
  ...
  "element-feature": {
    ...
    defaultHeight: 170,
    cornerRadius: 0.12,
    root: buildElementFeatureRoot(ELEMENT_FEATURE_VARIANT_VIOLET.root),
  },
...
const CARD_PALETTE_NODE_DEFAULTS = {
  ...
  "element-feature": ELEMENT_FEATURE_VARIANT_VIOLET.nodeProps,
  "detail-post": {
    sizeMode: "custom",
    borderStyle: "gradient",
