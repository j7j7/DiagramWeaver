...
const NodeChartLoopSchema = z.object({
  ...
  itemColorMode: z.enum(["same", "hue-step"]).optional(),
  itemHueStepDeg: z.number().min(1).max(360).optional(),
  arrowColor: z.string().optional(),
  arrowColorMode: z.enum(["fixed", "hue-step"]).optional(),
...
const NodeChartArrowSchema = z.object({
  ...
  segmentFillStyle: z.enum(["solid", "gradient"]).optional(),
  segmentFill: z.string().optional(),
  segmentFillStart: z.string().optional(),
