  ...
  if (orphanNodes.length > 0) {
    const orphanGroup: DiagramZoneItem = {
      ...
      label: '', // Invisible container
        ...
        frostedGlassQuality: (node as { frostedGlassQuality?: 'simulated' | 'backdrop' }).frostedGlassQuality,
...
function convertGroupToNested(
  ...
  return {
    ...
    frostedGlassQuality: (zone as { frostedGlassQuality?: 'simulated' | 'backdrop' }).frostedGlassQuality,
      ...
      zone.children?.forEach(child => {
        if (child.type !== 'zone') {
          ...
          const node: DiagramNodeData = {
            ...
            frostedGlassQuality: (nodeChild as { frostedGlassQuality?: 'simulated' | 'backdrop' }).frostedGlassQuality,
