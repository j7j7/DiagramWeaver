  ...
  if (orphanNodes.length > 0) {
    const orphanGroup: DiagramZoneItem = {
      ...
      label: '', // Invisible container
        ...
        shadow: node.shadow,
        highlightAnim: node.highlightAnim,
        highlightAnimDurationSec: node.highlightAnimDurationSec,
        highlightAnimIntervalSec: node.highlightAnimIntervalSec,
        highlightAnimGlowColor: node.highlightAnimGlowColor,
        borderBeam: node.borderBeam,
        borderBeamColors: node.borderBeamColors,
        borderBeamDurationSec: node.borderBeamDurationSec,
        borderBeamLength: node.borderBeamLength,
        borderBeamGlow: node.borderBeamGlow,
        borderBeamWidth: node.borderBeamWidth,
        borderBeamWobble: node.borderBeamWobble,
      ...
      zone.children?.forEach(child => {
        if (child.type !== 'zone') {
          ...
          const node: DiagramNodeData = {
            ...
            highlightAnimDurationSec: nodeChild.highlightAnimDurationSec,
            highlightAnimIntervalSec: nodeChild.highlightAnimIntervalSec,
            highlightAnimGlowColor: nodeChild.highlightAnimGlowColor,
            borderBeam: nodeChild.borderBeam,
            borderBeamColors: nodeChild.borderBeamColors,
            borderBeamDurationSec: nodeChild.borderBeamDurationSec,
            borderBeamLength: nodeChild.borderBeamLength,
            borderBeamGlow: nodeChild.borderBeamGlow,
            borderBeamWidth: nodeChild.borderBeamWidth,
            borderBeamWobble: nodeChild.borderBeamWobble,
            ...
            textJustify: nodeChild.textJustify,
             ...
             textOutlineWidth: nodeChild.textOutlineWidth,
             textOutlineColor: nodeChild.textOutlineColor,
             textGlowBlur: nodeChild.textGlowBlur,
             textGlowColor: nodeChild.textGlowColor,
             textShadowOffsetX: nodeChild.textShadowOffsetX,
             textShadowOffsetY: nodeChild.textShadowOffsetY,
             textShadowBlur: nodeChild.textShadowBlur,
             textShadowColor: nodeChild.textShadowColor,
             textDropShadowEnabled: nodeChild.textDropShadowEnabled,
             // Line shape specific properties
