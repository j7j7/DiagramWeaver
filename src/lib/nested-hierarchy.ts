  ...
  if (orphanNodes.length > 0) {
    const orphanGroup: DiagramZoneItem = {
      ...
      label: '', // Invisible container
        ...
        highlightAnimGlowIntensity: node.highlightAnimGlowIntensity,
        highlightAnimMode: node.highlightAnimMode,
      ...
      zone.children?.forEach(child => {
        if (child.type !== 'zone') {
          ...
          const node: DiagramNodeData = {
            ...
            highlightAnimGlowIntensity: nodeChild.highlightAnimGlowIntensity,
            highlightAnimMode: nodeChild.highlightAnimMode,
